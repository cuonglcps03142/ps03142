...
Public Class frmCapnhatsanpham
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim load As SqlDataAdapter = New SqlDataAdapter("select SANPHAMPS03142.MASP as 'Mã sản phẩm',SANPHAMPS03142.TENSP as 'Tên sản phẩm', LOAISANPHAMPS03142.MALOAI as 'Mã Loại', LOAISANPHAMPS03142.TENLOAI as 'Tên Loại',SANPHAMPS03142.SOLUONG as 'Số lượng' from SANPHAMPS03142 inner join LOAISANPHAMPS03142 on SANPHAMPS03142.MASP = LOAISANPHAMPS03142.MASP", conn)
    ...
    Private Sub btnCapnhat_Click(sender As Object, e As EventArgs) Handles btnCapnhat.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim updatequery As String = "update SANPHAMPS03142 set MASP=@MASP, TENSP=@TENSP, SOLUONG=@SOLUONG where MASP=@MASP update LOAISANPHAMPS03142 set MALOAI=@MALOAI, MASP=@MASP, TENLOAI=@TENLOAI where MASP=@MASP"
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        Dim delquery As String = "delete from SANPHAMPS03142 where MASP=@MASP delete from LOAISANPHAMPS03142 where MASP=@MASP"
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim query As String = "insert into SANPHAMPS03142 values(@MASP,@TENSP,@SOLUONG) insert into LOAISANPHAMPS03142 values(@MALOAI,@MASP,@TENLOAI)"
        ...
        Dim refesh As SqlDataAdapter = New SqlDataAdapter("select SANPHAMPS03142.MASP as 'Mã sản phẩm',SANPHAMPS03142.TENSP as 'Tên sản phẩm', LOAISANPHAMPS03142.MALOAI as 'Mã Loại', LOAISANPHAMPS03142.TENLOAI as 'Tên Loại',SANPHAMPS03142.SOLUONG as 'Số lượng' from SANPHAMPS03142 inner join LOAISANPHAMPS03142 on SANPHAMPS03142.MASP = LOAISANPHAMPS03142.MASP", conn)
        db.Clear()
        refesh.Fill(db)
        dgvSanpham.DataSource = db.DefaultView
    End Sub
